    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
                    ...
                    if (authenticator.authenticate(authtoken)) {
                        ...
                        if (request != null) {
                            ...
                            if (result.isSuccess()) {
                                ...
                                System.out.println("ListHandler: Successfully retrieved person data.");
            ...
            if (!success) {
                ...
                System.out.println("ListHandler: (Bad Request) " + result.getMessage());
            ...
            System.out.println("ListHandler: Failed to retrieve person data (Internal Server Error).");
            e.printStackTrace();
        }
    }
}
